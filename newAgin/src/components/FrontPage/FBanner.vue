<template>
  <div>
    <div id="container">
      <img id="img1" src="../../assets/img/1.jpg">
      <img id="img2" src="../../assets/img/2.jpg">
      <img id="img3" src="../../assets/img/3.jpg">
      <img id="img4" src="../../assets/img/4.jpg">
    </div>
  </div>
</template>
...
//          imageWidth = 768,
//          imageHeight = 485;
        imageWidth=document.getElementById('container').clientWidth;
        imageHeight=document.getElementById('container').clientHeight;
        var vertices = [],
          indices = [],
          prevfrag = [],
          fragments = [];
          ...
          image.onload = function () {
            if (++loaded === 1) {
              for (var i = 1; i < 4; i++) {
                ...
                image.src = urls[i].src;
              }
              placeImage();
            }
          };
          image.src = urls[0].src;
        };
        ...
        function triangulate() {
          for (var i = 0; i < 40; i++) {
           var  x = -margin + Math.random() * (imageWidth + margin * 2);
           var  y = -margin + Math.random() * (imageHeight + margin * 2);
            vertices.push([x, y]);
          }
          vertices.push([0, 0]);
